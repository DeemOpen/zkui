...
====================
1. `mvn clean install`
2. Copy the config.cfg to the folder with the jar file. Modify it to point to the zookeeper instance. Multiple ZooKeeper instances are comma separated, for example `server1:2181,server2:2181`. First server should always be the leader.
3. Run the jar
...
* Admin privileges, CRUD operations supported: username: `admin`, pwd: `manager`
* Readonly privileges, Read operations supported: username: `appconfig`, pwd: `appconfig`
